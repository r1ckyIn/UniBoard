...
export default function MaterialItem({
  ...
  return (
    <div
      className={`mat-item flex items-center gap-[14px] px-[14px] py-[12px] rounded-[8px] border-b border-[#eae7e0] last:border-b-0 transition-claude-fast hover:bg-[#efede6] ${url && onPreview ? "cursor-pointer" : "cursor-default"}`}
