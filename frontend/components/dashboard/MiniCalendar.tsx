    ...
    <RoughCard padding="py-4 px-5" disableHover>
      ...
      <div className="flex items-center justify-between mb-3">
        <button
          ...
          className="bg-transparent border-none cursor-pointer text-text-3 p-1 rounded-[6px] transition-claude-fast hover:bg-card-bg-hover hover:text-text-1 grid place-items-center"
        >
