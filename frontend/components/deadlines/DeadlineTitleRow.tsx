    ...
    <div className="flex items-center justify-between p-[0_2px] mb-[8px]">
      ...
      <div className="flex items-center gap-[8px]">
        ...
        <div className="flex border border-[#e8e5dd] rounded-[8px] overflow-hidden">
          <button
            type="button"
            className={`text-[0.72rem] font-semibold px-3 py-[5px] border-r border-[#e8e5dd] transition-colors [transition-duration:var(--motion-fast)] [transition-timing-function:var(--ease-claude-out)] ${
              filterMode === "all"
          ...
          <button
            type="button"
            className={`text-[0.72rem] font-semibold px-3 py-[5px] transition-colors [transition-duration:var(--motion-fast)] [transition-timing-function:var(--ease-claude-out)] ${
              filterMode === "week"
                ? "bg-[rgba(217,119,87,.1)] text-[#d97757]"
                : "bg-white text-[#9b9b94]"
            }`}
