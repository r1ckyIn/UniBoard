    ...
    <AnimatedEntry delay={1}>
      <div className="flex items-center justify-between px-[2px] mb-[4px]">
        ...
        <div className="flex items-center gap-[8px]">
          ...
          <button
            className="flex items-center gap-[5px] text-[0.74rem] font-semibold py-[6px] px-[12px] rounded-[8px] bg-[#f6f5f0] border border-[#e8e5dd] text-[#6b6b65] cursor-pointer hover:bg-[#efede6] hover:text-[#2d2d2a] transition-all [transition-duration:var(--motion-fast)] [transition-timing-function:var(--ease-claude-out)]"
            disabled={isFetching}
            onClick={onRefresh}
          >
            <RefreshCw
