...
export default function NotificationPanel({
  ...
  return (
    ...
    >
      ...
      {/* Footer */}
      <div
        className="px-4 py-3 text-center text-[0.76rem] font-semibold text-orange border-t border-divider cursor-pointer transition-colors duration-[0.15s] hover:bg-card-bg-hover"
        onClick={onViewAll}
      >
