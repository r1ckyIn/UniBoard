      ...
      <div className="flex flex-col gap-[16px]">
        ...
        <div className="flex items-center justify-between pt-[14px] border-t border-[#eae7e0]">
          <button
            ...
            className="py-[8px] px-[16px] text-[0.78rem] font-semibold rounded-[8px] bg-[#d97757] text-white border-none cursor-pointer transition-claude-fast hover:bg-[#c5674a]"
          >
