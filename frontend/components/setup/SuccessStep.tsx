    ...
    <div className="flex flex-col items-center text-center">
      ...
      {showDashboard && (
        <button
          ...
          className="mt-8 bg-[#d97757] hover:bg-[#c5674a] text-white font-semibold py-3 px-10 rounded-lg transition-all [transition-duration:var(--motion-fast)] [transition-timing-function:var(--ease-claude-out)] ease-in-out hover:-translate-y-px inline-flex items-center gap-2"
        >
