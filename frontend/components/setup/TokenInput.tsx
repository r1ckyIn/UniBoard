    ...
    <div>
      ...
      <div className="flex items-center relative">
        <input
          ...
          className={cn(
            "w-full font-mono text-sm py-3 px-4 border-[1.5px] rounded-lg bg-cream transition-all [transition-duration:var(--motion-fast)] [transition-timing-function:var(--ease-claude-out)] ease-in-out placeholder:font-sans",
