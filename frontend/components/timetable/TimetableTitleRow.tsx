  ...
  return (
    <div className="flex items-center justify-between px-[2px] mb-[8px]">
      ...
      <div className="flex items-center gap-[8px]">
        <button
          className={cn(
            "w-[30px] h-[30px] rounded-[8px] border border-[#e8e5dd] bg-[#f6f5f0] grid place-items-center cursor-pointer text-[#6b6b65] transition-all [transition-duration:var(--motion-fast)] [transition-timing-function:var(--ease-claude-out)] hover:bg-[#efede6] hover:text-[#2d2d2a]",
        ...
        <div className="flex border border-[#e8e5dd] rounded-[8px] overflow-hidden">
          <button
            className={cn(
              "text-[0.72rem] font-semibold px-[12px] py-[5px] border-r border-[#e8e5dd] cursor-pointer transition-all [transition-duration:var(--motion-fast)] [transition-timing-function:var(--ease-claude-out)] whitespace-nowrap",
              mode === "all"
          ...
          <button
            className={cn(
              "text-[0.72rem] font-semibold px-[12px] py-[5px] cursor-pointer transition-all [transition-duration:var(--motion-fast)] [transition-timing-function:var(--ease-claude-out)] whitespace-nowrap",
              mode === "week"
                ? "bg-[rgba(217,119,87,0.11)] text-[#d97757]"
                : "bg-white text-[#9b9b94] hover:text-[#2d2d2a] hover:bg-[#efede6]"
            )}
